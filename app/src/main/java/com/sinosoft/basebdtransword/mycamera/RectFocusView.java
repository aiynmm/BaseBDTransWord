package com.sinosoft.basebdtransword.mycamera;
...
public class RectFocusView extends View {
    ...
    public RectFocusView(Context context) {
        this(context, null);
    }

    public RectFocusView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RectFocusView(Context context, AttributeSet attrs, int defStyleAttr) {
